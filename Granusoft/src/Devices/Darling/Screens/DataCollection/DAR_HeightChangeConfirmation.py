...
class DAR_HeightChangeConfirmation(BaseScreen):
    ...
    def save_new_height(self):
        ...
        super(DAR_HeightChangeConfirmation, self).move_to('dar_test_in_progress_screen')
    ...
    def height_change_popup(self):
        self._popup = DAR_HeightChangeConfirmDialog(cancel=self.dismiss_popup, proceed=self.save_new_height)
        self._popup.open()

    def dismiss_popup(self):
        self._popup.dismiss()
        super(DAR_HeightChangeConfirmation, self).move_to('dar_testing_screen_auto')
