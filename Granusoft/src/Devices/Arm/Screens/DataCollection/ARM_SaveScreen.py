...
import datetime
from Devices.Arm.Data.TestSingleton import TestSingleton
...
class ARM_SaveScreen(BaseScreen):
    ...
    def on_pre_enter(self):
        ...
        if use_barcode == "OFF":
            ...
            super(ARM_SaveScreen, self).move_to(self.next_screen)
    ...
    def check_height_sensor_status(self):
        if str(config.get('height_sensor', 0)) == "ON":
            self.next_screen = 'arm_testing_screen_auto'
        else:
            self.next_screen = 'arm_testing_screen'