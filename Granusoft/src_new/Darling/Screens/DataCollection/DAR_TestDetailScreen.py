...
class DAR_TestDetailScreen(BaseScreen):
    ...
    def __init__(self, **kwargs):
        ...
        def gui_init(dt):
            self.dar_test_notes_screen = self.manager.get_screen('dar_test_notes_screen')
    ...
    def update_notes(self):
        self.dar_test_notes_screen.set_file(self.fileName)
        super(DAR_TestDetailScreen, self).move_to('dar_test_notes_screen')